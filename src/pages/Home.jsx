    ...
    <div className='mx-auto px-2 md:px-8 xl:max-w-screen-xl lg:max-w-screen-lg md:max-w-screen-md sm:max-w-screen-sm xs:max-w-screen-xs max-w-sm'>
      <div className='bg-rose-700 rounded-b-[32px] h-[40rem] flex gap-8 items-center px-24 overflow-hidden'>
        <div className='flex-1 flex flex-col gap-5'>
          ...
          <h3 className='lg:text-[3rem] md:text-[3rem] text-[2.5rem] leading-none font-bold text-white'>
          ...
          <div className='flex gap-10'>
            <a
              className='cursor-pointer border-white border-2 hover:bg-white hover:text-black text-white font-bold py-3 px-8 rounded-full hover:shadow'
            >
              My Work Info
            </a>
            <a
        ...
        <div className='rounded-full bg-[#fdb813] flex-1 mt-auto'>

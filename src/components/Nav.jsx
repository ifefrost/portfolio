...
const Nav = () => {
  ...
  return (
    <nav className='sticky top-0 z-10 shadow-md dark:bg-slate-900 dark:text-white duration-100'>
        ...
        <div className='flex justify-between'>
          ...
          >
            <div className='flex flex-col sm:flex-row sm:space-x-4 absolute sm:static right-2 top-11 mt-5 sm:mt-0 bg-rose-900 sm:bg-inherit px-1 py-2 items-center sm:gap-0 rounded-b-xl w-max'>
              <Link
                to='/work'
                className='text-center w-full text-black dark:text-white hover:bg-gray-100 hover:text-rose-700 px-3 py-2 rounded-md text-sm font-medium'
              >
                Work
              </Link>
              <Link
              ...
              <h1 className='text-center w-full text-black dark:text-white hover:bg-gray-100 hover:text-rose-700 px-3 py-2 rounded-md text-sm font-medium'>
                Resume
              </h1>
              <h1 className='text-center w-full text-black dark:text-white hover:bg-gray-100 hover:text-rose-700 px-3 py-2 rounded-md text-sm font-medium'>
                Connect
